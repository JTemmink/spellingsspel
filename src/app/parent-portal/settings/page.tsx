    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-100 to-blue-100 p-4" data-theme="light">
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <motion.div
          ...
          className="card bg-info/10 shadow-lg mt-6"
        >
          <div className="card-body">
            <h2 className="card-title text-lg">💡 Tips voor Ouders</h2>
            <div className="space-y-2 text-sm">
              <p>• <strong>Wachtwoord:</strong> Kies een wachtwoord dat alleen u kent</p>
              <p>• <strong>Punten:</strong> Gebruik punten aanpassing spaarzaam als motivatie</p>
              <p>• <strong>Systeem:</strong> Lagere punten per woord verhogen de motivatie om meer te oefenen</p>
              <p>• <strong>Tijd Bonus:</strong> Stimuleert korte, frequente oefensessies</p>
            </div>
          </div>
        </motion.div>
      </div>
